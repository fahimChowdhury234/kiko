...
(function (exp) {
  ...
  `,
   ...
   const reviewsArr = [
      {
         ...
         review: "I am in love with these glosses. They are available in the most popular shades. They have a very nice consistency and shine very well on the lips. I am very satisfied.",
      },
      {
         name: "Emma ",
         time: "2 days ago",
         ...
         review: "This is a very cool set, Kiko's glosses have the best texture and good shine",
      },
      {
         name: "Hannah ",
         time: "3 days ago",
         ...
         review: "I ordered it as a gift for my daughter, she has been wanting Kiko lip glosses for a long time",
      },
      {
         name: "Lina ",
         time: "5 days ago",
      ...
      },
      {
         ...
         review: "It's not the first time I buy Kiko Milano cosmetics, always of excellent quality",
      },
   ];
   ...
   const check = {
      ...
      arr: ["You have answered Question 3/3.", "Your IP address does not reveal any previous requests.", "Your answer has been verified."],
   };
   ...
   const products = [
      {
         ...
         images: ["./assets/P_1.webp", "./assets/P_2.webp", "./assets/P_3.webp", "./assets/P_4.webp"],
      },
   ];
...
const lsSelectProduct = (val) => localStorage.setItem("__selected_product", val);
